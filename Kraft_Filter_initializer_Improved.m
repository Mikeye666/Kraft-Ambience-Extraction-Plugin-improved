...
dS_Fr = designfilt('highpassiir', 'FilterOrder', 20, 'HalfPowerFrequency', 10000, 'SampleRate', fs);
S_fr = abs(freqz(dS_Fr, window_size));
%S_fr = S_fr.^4;
H_A_Rr = RRr.*S_fr;
H_A_Fr = 1-H_A_Rr;

dS_LH = designfilt('lowpassiir', 'FilterOrder', 20, 'HalfPowerFrequency', 1000, 'SampleRate', fs);
...
save kraftFilterDataSigma.dat sigmas -ascii;
